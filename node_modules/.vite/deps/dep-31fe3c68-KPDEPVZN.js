...
var Parser = class {
  ...
  shouldProcessStartTagTokenInForeignContent(token2) {
    ...
    return (
      ...
      this.tokenizer.inForeignNode || (token2.tagID === TAG_ID.MGLYPH || token2.tagID === TAG_ID.MALIGNMARK) && !this._isIntegrationPoint(currentTagId, current, NS.HTML)
    );
  }
...
function serializeAttributes(node, { treeAdapter }) {
  ...
  for (const attr of treeAdapter.getAttrList(node)) {
    ...
    html2 += `="${escapeAttribute(attr.value)}"`;
  }
  return html2;
}
...
//# sourceMappingURL=dep-31fe3c68-KPDEPVZN.js.map
