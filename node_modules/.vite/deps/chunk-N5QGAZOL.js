import {
  require_node_path
} from "./chunk-SZRVVJLJ.js";
import {
  require_path
} from "./chunk-T2KTTIFH.js";
import {
  __commonJS,
  __toESM
    ...
    module.exports = Object.create(new Proxy({}, {
      get(_, key) {
        if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") {
          console.warn(`Module "node:perf_hooks" has been externalized for browser compatibility. Cannot access "node:perf_hooks.${key}" in client code.`);
        }
      }
    }));
  }
...
var require_tty = __commonJS({
  "browser-external:tty"(exports, module) {
    module.exports = Object.create(new Proxy({}, {
      get(_, key) {
        if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") {
          console.warn(`Module "tty" has been externalized for browser compatibility. Cannot access "tty.${key}" in client code.`);
        }
      }
    }));
  }
...
var require_node_crypto = __commonJS({
  "browser-external:node:crypto"(exports, module) {
    module.exports = Object.create(new Proxy({}, {
      get(_, key) {
        if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") {
          console.warn(`Module "node:crypto" has been externalized for browser compatibility. Cannot access "node:crypto.${key}" in client code.`);
        }
      }
    }));
  }
...
var require_node_process = __commonJS({
  "browser-external:node:process"(exports, module) {
    module.exports = Object.create(new Proxy({}, {
      get(_, key) {
        if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") {
          console.warn(`Module "node:process" has been externalized for browser compatibility. Cannot access "node:process.${key}" in client code.`);
        }
      }
    }));
  }
...
var UNKNOWN_ARG = [UNKNOWN_EXPRESSION];
...
var pm = getDefaultExportFromCjs(picomatchExports);
var extractors = {
...
var BROKEN_FLOW_NONE = 0;
var BROKEN_FLOW_BREAK_CONTINUE = 1;
var BROKEN_FLOW_ERROR_RETURN_LABEL = 2;
...
var SpreadElement = class extends NodeBase {
  deoptimizeThisOnInteractionAtPath(interaction, path2, recursionTracker) {
    if (path2.length > 0) {
      this.argument.deoptimizeThisOnInteractionAtPath(interaction, [UnknownKey, ...path2], recursionTracker);
    }
  }
  hasEffects(context) {
    if (!this.deoptimized)
...
var Method = class extends ExpressionEntity {
  ...
  hasEffectsOnInteractionAtPath(path2, interaction, context) {
    ...
    if (type === INTERACTION_CALLED) {
      ...
      if (this.description.mutatesSelfAsArray === true && (thisArg == null ? void 0 : thisArg.hasEffectsOnInteractionAtPath(UNKNOWN_INTEGER_PATH, NODE_INTERACTION_UNKNOWN_ASSIGNMENT, context))) {
        return true;
      }
      if (this.description.callsArgs) {
        for (const argumentIndex of this.description.callsArgs) {
          if ((_a = args[argumentIndex]) == null ? void 0 : _a.hasEffectsOnInteractionAtPath(EMPTY_PATH, NODE_INTERACTION_UNKNOWN_CALL, context)) {
            return true;
          }
        }
      }
...
var ObjectEntity = class extends ExpressionEntity {
  ...
  deoptimizeThisOnInteractionAtPath(interaction, path2, recursionTracker) {
    ...
    if (this.hasLostTrack || (interaction.type === INTERACTION_CALLED || path2.length > 1) && (this.hasUnknownDeoptimizedProperty || typeof key === "string" && this.deoptimizedPaths[key])) {
      interaction.thisArg.deoptimizePath(UNKNOWN_PATH);
      return;
    }
    const [propertiesForExactMatchByKey, relevantPropertiesByKey, relevantUnmatchableProperties] = interaction.type === INTERACTION_CALLED || path2.length > 1 ? [
      this.propertiesAndGettersByKey,
      this.propertiesAndGettersByKey,
      this.unmatchablePropertiesAndGetters
    ] : interaction.type === INTERACTION_ACCESSED ? [this.propertiesAndGettersByKey, this.gettersByKey, this.unmatchableGetters] : [this.propertiesAndSettersByKey, this.settersByKey, this.unmatchableSetters];
    if (typeof key === "string") {
    ...
    (_a = this.prototypeExpression) == null ? void 0 : _a.deoptimizeThisOnInteractionAtPath(interaction, path2, recursionTracker);
  }
...
var OBJECT_PROTOTYPE_FALLBACK = new class ObjectPrototypeFallbackExpression extends ExpressionEntity {
  deoptimizeThisOnInteractionAtPath({ type, thisArg }, path2) {
    if (type === INTERACTION_CALLED && path2.length === 1 && !isInteger(path2[0])) {
      thisArg.deoptimizePath(UNKNOWN_PATH);
    }
  }
...
var ArrayExpression = class extends NodeBase {
  ...
  deoptimizeThisOnInteractionAtPath(interaction, path2, recursionTracker) {
    this.getObjectEntity().deoptimizeThisOnInteractionAtPath(interaction, path2, recursionTracker);
  }
  getLiteralValueAtPath(path2, recursionTracker, origin) {
...
var LocalVariable = class extends Variable {
  ...
  addDeclaration(identifier, init2) {
    ...
    if (init2 !== null) {
      additionalInitializers.push(init2);
    }
  }
  ...
  deoptimizePath(path2) {
    ...
    if (path2.length === 0) {
      if (!this.isReassigned) {
        ...
        (_a = this.init) == null ? void 0 : _a.deoptimizePath(UNKNOWN_PATH);
      }
    } else {
      (_b = this.init) == null ? void 0 : _b.deoptimizePath(path2);
    }
  }
  deoptimizeThisOnInteractionAtPath(interaction, path2, recursionTracker) {
    ...
    recursionTracker.withTrackedEntityAtPath(path2, this.init, () => this.init.deoptimizeThisOnInteractionAtPath(interaction, path2, recursionTracker), void 0);
  }
  getLiteralValueAtPath(path2, recursionTracker, origin) {
    if (this.isReassigned || !this.init) {
      return UnknownValue;
  ...
  hasEffectsOnInteractionAtPath(path2, interaction, context) {
    switch (interaction.type) {
      case INTERACTION_ACCESSED: {
        if (this.isReassigned)
          return true;
        return this.init && !context.accessed.trackEntityAtPathAndGetIfTracked(path2, this) && this.init.hasEffectsOnInteractionAtPath(path2, interaction, context);
      }
      case INTERACTION_ASSIGNED: {
        ...
        if (this.isReassigned)
          return true;
        return this.init && !context.assigned.trackEntityAtPathAndGetIfTracked(path2, this) && this.init.hasEffectsOnInteractionAtPath(path2, interaction, context);
      }
      case INTERACTION_CALLED: {
        if (this.isReassigned)
          return true;
        return this.init && !(interaction.withNew ? context.instantiated : context.called).trackEntityAtPathAndGetIfTracked(path2, interaction.args, this) && this.init.hasEffectsOnInteractionAtPath(path2, interaction, context);
      }
    }
  }
  include() {
...
var Identifier = class extends NodeBase {
  ...
  deoptimizeThisOnInteractionAtPath(interaction, path2, recursionTracker) {
    this.variable.deoptimizeThisOnInteractionAtPath(interaction, path2, recursionTracker);
  }
  getLiteralValueAtPath(path2, recursionTracker, origin) {
...
var ThisVariable = class extends LocalVariable {
  constructor(context) {
  ...
  addEntityToBeDeoptimized(entity) {
    for (const path2 of this.deoptimizedPaths) {
      entity.deoptimizePath(path2);
    }
    for (const { interaction, path: path2 } of this.thisDeoptimizationList) {
      entity.deoptimizeThisOnInteractionAtPath(interaction, path2, SHARED_RECURSION_TRACKER);
    }
    this.entitiesToBeDeoptimized.add(entity);
  }
  deoptimizePath(path2) {
    if (path2.length === 0 || this.deoptimizationTracker.trackEntityAtPathAndGetIfTracked(path2, this)) {
      return;
    }
    this.deoptimizedPaths.push(path2);
    for (const entity of this.entitiesToBeDeoptimized) {
      entity.deoptimizePath(path2);
    }
  }
  deoptimizeThisOnInteractionAtPath(interaction, path2) {
    const thisDeoptimization = {
      interaction,
      path: path2
    };
    if (!this.thisDeoptimizations.trackEntityAtPathAndGetIfTracked(path2, interaction.type, interaction.thisArg)) {
      for (const entity of this.entitiesToBeDeoptimized) {
        entity.deoptimizeThisOnInteractionAtPath(interaction, path2, SHARED_RECURSION_TRACKER);
      }
  ...
  hasEffectsOnInteractionAtPath(path2, interaction, context) {
    return this.getInit(context).hasEffectsOnInteractionAtPath(path2, interaction, context) || super.hasEffectsOnInteractionAtPath(path2, interaction, context);
  }
  getInit(context) {
...
var FunctionNode = class extends FunctionBase {
  ...
  deoptimizeThisOnInteractionAtPath(interaction, path2, recursionTracker) {
    super.deoptimizeThisOnInteractionAtPath(interaction, path2, recursionTracker);
    if (interaction.type === INTERACTION_CALLED && path2.length === 0) {
  ...
  hasEffectsOnInteractionAtPath(path2, interaction, context) {
    ...
    if (interaction.type === INTERACTION_CALLED) {
      ...
      context.replacedVariableInits.set(this.scope.thisVariable, interaction.withNew ? new ObjectEntity(/* @__PURE__ */ Object.create(null), OBJECT_PROTOTYPE) : UNKNOWN_EXPRESSION);
...
var Literal = class extends NodeBase {
  ...
  getLiteralValueAtPath(path2) {
    if (path2.length > 0 || this.value === null && this.context.code.charCodeAt(this.start) !== 110 || typeof this.value === "bigint" || // to support shims for regular expressions
...
var MemberExpression = class extends NodeBase {
  ...
  deoptimizeThisOnInteractionAtPath(interaction, path2, recursionTracker) {
    if (this.variable) {
      ...
      if (path2.length < MAX_PATH_DEPTH) {
        this.object.deoptimizeThisOnInteractionAtPath(interaction, [this.getPropertyKey(), ...path2], recursionTracker);
      } else {
        interaction.thisArg.deoptimizePath(UNKNOWN_PATH);
      }
    }
  ...
  applyDeoptimizations() {
    this.deoptimized = true;
    const { propertyReadSideEffects } = this.context.options.treeshake;
    if (// Namespaces are not bound and should not be deoptimized
  ...
  deoptimizeThisOnInteractionAtPath(interaction, path2, recursionTracker) {
    ...
    if (returnExpression === UNKNOWN_EXPRESSION) {
      ...
      recursionTracker.withTrackedEntityAtPath(path2, returnExpression, () => {
        ...
        returnExpression.deoptimizeThisOnInteractionAtPath(interaction, path2, recursionTracker);
      }, null);
    }
  }
  getLiteralValueAtPath(path2, recursionTracker, origin) {
...
var MethodBase = class extends NodeBase {
  ...
  deoptimizeThisOnInteractionAtPath(interaction, path2, recursionTracker) {
    ...
    this.getAccessedValue()[0].deoptimizeThisOnInteractionAtPath(interaction, path2, recursionTracker);
  }
  getLiteralValueAtPath(path2, recursionTracker, origin) {
...
var ObjectMember = class extends ExpressionEntity {
  ...
  deoptimizeThisOnInteractionAtPath(interaction, path2, recursionTracker) {
    this.object.deoptimizeThisOnInteractionAtPath(interaction, [this.key, ...path2], recursionTracker);
  }
  getLiteralValueAtPath(path2, recursionTracker, origin) {
...
var ConditionalExpression = class extends NodeBase {
  ...
  deoptimizeThisOnInteractionAtPath(interaction, path2, recursionTracker) {
    this.consequent.deoptimizeThisOnInteractionAtPath(interaction, path2, recursionTracker);
    this.alternate.deoptimizeThisOnInteractionAtPath(interaction, path2, recursionTracker);
  }
  getLiteralValueAtPath(path2, recursionTracker, origin) {
    const usedBranch = this.getUsedBranch();
    if (!usedBranch)
  ...
  hasEffects(context) {
    ...
    if (typeof testValue === "symbol") {
      ...
      if (this.alternate.hasEffects(context))
        return true;
      context.brokenFlow = // eslint-disable-next-line unicorn/consistent-destructuring
...
var LogicalExpression = class extends NodeBase {
  ...
  deoptimizeThisOnInteractionAtPath(interaction, path2, recursionTracker) {
    this.left.deoptimizeThisOnInteractionAtPath(interaction, path2, recursionTracker);
    this.right.deoptimizeThisOnInteractionAtPath(interaction, path2, recursionTracker);
  }
  getLiteralValueAtPath(path2, recursionTracker, origin) {
    const usedBranch = this.getUsedBranch();
    if (!usedBranch)
...
var PropertyDefinition = class extends NodeBase {
  ...
  deoptimizeThisOnInteractionAtPath(interaction, path2, recursionTracker) {
    var _a;
    (_a = this.value) == null ? void 0 : _a.deoptimizeThisOnInteractionAtPath(interaction, path2, recursionTracker);
  }
  getLiteralValueAtPath(path2, recursionTracker, origin) {
...
var SequenceExpression = class extends NodeBase {
  ...
  deoptimizeThisOnInteractionAtPath(interaction, path2, recursionTracker) {
    this.expressions[this.expressions.length - 1].deoptimizeThisOnInteractionAtPath(interaction, path2, recursionTracker);
  }
  getLiteralValueAtPath(path2, recursionTracker, origin) {
...
var ThisExpression = class extends NodeBase {
  ...
  deoptimizeThisOnInteractionAtPath(interaction, path2, recursionTracker) {
    this.variable.deoptimizeThisOnInteractionAtPath(interaction.thisArg === this ? { ...interaction, thisArg: this.variable } : interaction, path2, recursionTracker);
  }
  hasEffectsOnInteractionAtPath(path2, interaction, context) {
    if (path2.length === 0) {
...
var NamespaceVariable = class extends Variable {
  ...
  deoptimizeThisOnInteractionAtPath(interaction, path2, recursionTracker) {
    ...
    if (path2.length > 1 || path2.length === 1 && interaction.type === INTERACTION_CALLED) {
      const key = path2[0];
      if (typeof key === "string") {
        (_a = this.getMemberVariables()[key]) == null ? void 0 : _a.deoptimizeThisOnInteractionAtPath(interaction, path2.slice(1), recursionTracker);
      } else {
        interaction.thisArg.deoptimizePath(UNKNOWN_PATH);
      }
    }
...
function getChunkAssignments(entries, manualChunkAliasByEntry, minChunkSize) {
  ...
  const assignedEntriesByModule = /* @__PURE__ */ new Map();
  ...
  for (const currentEntry of allEntries) {
    ...
    for (const module of modulesToHandle) {
      ...
      for (const { resolution } of module.dynamicImports) {
        if (resolution instanceof Module && resolution.includedDynamicImporters.length > 0 && !allEntries.has(resolution)) {
...
function assignEntryToStaticDependencies(entry, dependentEntriesByModule, assignedEntriesByModule, modulesInManualChunks, staticEntries, dynamicallyDependentEntriesByDynamicEntry) {
  ...
  for (const module of modulesToHandle) {
    ...
    if (dynamicallyDependentEntries && isModuleAlreadyLoaded(dynamicallyDependentEntries, dependentEntriesByModule.get(module), staticEntries, dynamicallyDependentEntriesByDynamicEntry)) {
      continue;
    } else {
...
var MAX_ENTRIES_TO_CHECK_FOR_SHARED_DEPENDENCIES = 3;
function isModuleAlreadyLoaded(dynamicallyDependentEntries, containedIn, staticEntries, dynamicallyDependentEntriesByDynamicEntry) {
  ...
  for (const entry of entriesToCheck) {
    if (!containedIn.has(entry)) {
      ...
      const dynamicallyDependentEntries2 = dynamicallyDependentEntriesByDynamicEntry.get(entry);
      if (dynamicallyDependentEntries2.size > MAX_ENTRIES_TO_CHECK_FOR_SHARED_DEPENDENCIES) {
        return false;
      }
      for (const dependentEntry of dynamicallyDependentEntries2) {
...
var CHAR_DEPENDENT = "X";
var CHAR_INDEPENDENT = "_";
var CHAR_CODE_DEPENDENT = CHAR_DEPENDENT.charCodeAt(0);
...
function getMergeableChunks(chunkModulesBySignature, minChunkSize) {
  const chunksToBeMerged = /* @__PURE__ */ new Set();
...
function mergeSignatures(sourceSignature, targetSignature) {
  ...
  const { length } = sourceSignature;
  for (let index = 0; index < length; index++) {
    signature += sourceSignature.charCodeAt(index) === CHAR_CODE_DEPENDENT || targetSignature.charCodeAt(index) === CHAR_CODE_DEPENDENT ? CHAR_DEPENDENT : CHAR_INDEPENDENT;
  }
  return signature;
}
...
var acorn = Object.defineProperty({
  __proto__: null,
  Node,
  Parser,
  Position,
...
var lib = {};
var require$$0 = getAugmentedNamespace(acorn);
...
function importAssertions(Parser3) {
  const acorn2 = Parser3.acorn || _acorn;
  const {
    tokTypes: tt,
...
var getOptionWithPreset = (value, presets, optionName, additionalValues) => {
...
var getHashFromObjectOption = (optionName) => optionName.split(".").join("").toLowerCase();
...
var getCache = (config) => {
  var _a;
  return ((_a = config.cache) == null ? void 0 : _a.cache) || config.cache;
};
...
async function watchInternal(configs, emitter) {
  ...
  await loadFsEvents();
  const { Watcher } = await import("./watch-MTJFCL74.js");
...
rollup/dist/es/shared/rollup.js:
  (*
    @license
  	Rollup.js v3.9.1
  ...
  *)
*/
//# sourceMappingURL=chunk-N5QGAZOL.js.map
